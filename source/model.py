...
class Model:
    ...
    def calculate_information_presence_in_memory(self):
        ...
        for word_embedding in self.text.embedded_text:
            info_about_word = 0
            for index, cell in enumerate(self.memory.memory):
                info_about_word += np.dot(np.array(word_embedding), np.array(cell))
...
if __name__ == "__main__":
    ...
    #print(model.calculate_information_presence_in_memory())
